...
export type AgeSignalsError = BelowMinimumAgeError | ApiNotAvailableError | NetworkError | PlayStoreNotFoundError | AppNotOwnedError | InvalidRequestError | InternalError;
/**
 ...
 * ```
 */
export declare function checkAgeRange(minimumAge: number): Promise<boolean | null>;
